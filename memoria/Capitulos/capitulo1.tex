...
\begin{itemize}
	...
	\item Adoptar de un árbol o colmena de la finca para recibir su producción anualmente, siguiendo un modelo de \textquote{suscripción} (véase la figura \ref{fig:delcarmen-landing}).
...
\figura{0.75}{img/naranjas-del-carmen/blog}{Blog de Naranjas del Carmen}{fig:delcarmen-blog}{}
...
\figura{0.75}{img/naranjas-del-carmen/adoptar-naranjo}{Página de adoptar un naranjo en Naranjas del Carmen}{fig:delcarmen-adoptar}{}

\subsection{CrowdFarming}

CrowdFarming es una plataforma web y móvil que permite comprar productos de temporada sin intermediarios, promoviendo una agricultura europea más humana y sostenible. La idea surge de los creadores de plataforma Naranjas del Carmen, con la diferencia de que CrowdFarming evoluciona a un modelo de \textquote{marketplace} en el que no es necesario adoptar un árbol para poder adquirir productos como ocurría en la plataforma hermana.

La web de CrowdFarming también apuesta por un diseño de una sola página. El contenido se divide a lo largo de la página principal en secciones delimitadas por colores: Se muestra una cabecera de tipo \textquote{Hero} con imagen y texto grandes, seguida de maneras de generar impacto en CrowdFarming (véase la figura \ref{fig:crowd-impacto}), una lista de productos disponibles (véase la figura \ref{fig:crowd-productos}), estadísticas de uso de la plataforma y una sección destacada de productores, que ofrece un vistazo rápido a la funcionalidad principal del portal: el mercado de compraventa.

\figura{0.75}{img/crowdfarming/impacto}{Maneras de generar impacto mediante CrowdFarming}{fig:crowd-impacto}{}

\figura{0.75}{img/crowdfarming/productos}{Oferta de productos en CrowdFarming}{fig:crowd-productos}{}
...
% TODO: El enlace no funciona porque tengo que escapar los símbolos de % usando \ y url{} me los incluye en el documento, rompiendo la URL. Buscar alternativa.
...
\begin{itemize}
	...
	\item Adoptar un árbol o colmena de un productor local para recibir su producción anualmente, siguiendo un modelo de \textquote{suscripción} (véase la figura \ref{fig:crowd-impacto}).
	...
	\item Comprar productos a agricultores independientes (modelo \textquote{marketplace}).
...
\figura{0.75}{img/crowdfarming/empresas}{Planes para empresas de Crowdfarming}{fig:crowd-empresas}{}

\figura{0.75}{img/crowdfarming/blog}{Blog de Crowdfarming}{fig:crowd-blog}{}
...
\figura{0.75}{img/ftp/landing}{Página principal de Farm to People}{fig:ftp-landing}{}
...
Recientemente ha abierto en Brooklyn el llamado \textquote{Farm to People Kitchen \& Bar}, que sirve platos de temporada elaborados únicamente con productos de agricultores y granjeros que colaboran con la plataforma.

\subsubsection{Funcionalidades}

\begin{itemize}

	\item Solicitar productos habituales mediante una suscripción semanal a los mismos, así como solicitar \textquote{Seasonal Produce Boxes} en diferentes tamaños con productos de temporada
...
\figura{0.75}{img/ftp/recetas}{Blog de recetas de Farm To People}{fig:ftp-recetas}{}
...
\figura{0.75}{img/ftp/preparados}{Comidas preparadas en Farm To People}{fig:ftp-preparados}{}
...
La página web presenta un diseño de una sola página con una barra de navegación con pestañas que se desplazan hasta cada una de las secciones mediante \textquote{anchors}. Lo primero que vemos al entrar a la web es una cabecera de tipo \textquote{Hero} con imagen y texto grandes (véase la figura \ref{fig:bijak-landing}), seguida por las categorías que se destacan en la barra de navegación superior: funcionalidades, testimonios de usuarios, estadísticas de uso, cobertura en medios de comunicación y empresas colaboradoras.

\figura{0.75}{img/bijak/landing}{Página principal de Bijak}{fig:bijak-landing}{}
...
\figura{0.75}{img/mandi-trades/interfaz}{Interfaz de Mandi Trades}{fig:mandi-interfaz}{}
